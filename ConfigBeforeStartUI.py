...
def helloCallBack():
   ...
   deviceIdSql=MYSQL()
   MYSQL.insert(DeviceID,deviceId.get())
...
def configBeforeStart():
   ...
   Radiobutton(root,text='test',variable=serverAddr,value='dd').grid(row=3,column=0,padx=10,pady=5,sticky=W)
   Radiobutton(root,text='online',variable=serverAddr,value='online').grid(row=3,column=1,padx=10,pady=5,sticky=E)
